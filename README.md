...
## One Liner Install
Clone the repo, make everything executable, and launch the menu in one shot:
```bash
git clone https://github.com/XEXModz/proxmox-tools.git && cd proxmox-tools && chmod +x *.sh && sudo ./run.sh
```
